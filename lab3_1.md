...
```
## [1] "C:/Users/ericc/Desktop/BIS15W2021_ecoyle"
```
...
```r
temp_C <- c(36.25, 35.40, 35.30, 35.15, 35.35, 33.35, 30.70, 29.65, 29.20)
...
```r
hsprings<-data.frame(spring,name,temp_C)
hsprings
```
...
```r
hsprings<-data.frame(spring=spring,scientist=name,temp_C=temp_C)
names(hsprings)
```

```
## [1] "spring"    "scientist" "temp_C"
```
