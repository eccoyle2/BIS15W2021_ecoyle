...
```
#inner join includes shared rows in the specified column of both data frames
...
#> # ... with 2 more variables: gender <chr>, favorite <chr>
```
#left join includes rows based on the values in the specified column of the first listed data frame but not those that are unique to the second
...
#> # ... with 2 more variables: gender <chr>, favorite <chr>
```
#right join includes rows based on the values in the speciified colum of the second listed data frame, which in thise case results in more NA alues since that value does not appear in the first data frame and consequently does not have entries in columns unique to the first data frame
...
#> # ... with 2 more variables: gender <chr>, favorite <chr>
```
#full join includes values in the specified column for both listed data frrames
...
#> Skipping install of 'albersusa' from a gitlab remote, the SHA1 (07aa87f6) has not changed since last install.
